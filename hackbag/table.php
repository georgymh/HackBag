  ...
  <body style="font-size:14px">
    <div class="container">
      ...
      <div class="container-fluid">
        ...
        <p class="navbar-text navbar-right" style="margin-top:5px; margin-bottom:5px">Signed in as <a href="#" class="navbar-link" style="margin-right: 10px">Mark Otto</a> <img src="http://st2.depositphotos.com/2571355/7122/v/110/depositphotos_71222099-Sleeping-bag-flat-square-icon-with-long-shadows..jpg" class="img-rounded" alt="Cinque Terre" style="border-radius:50%; width: 50px; height:50px; margin-right: 10px"> </p>
